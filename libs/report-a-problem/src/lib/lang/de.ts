export const de = {
  // popover
  notesAndComments: 'Persönliche Notizen und Kommentare',
  reportAProblem: 'Ein Problem melden',
  newIssueCreated: 'Neues Problem erstellt',
  somethingWrong: 'Etwas ist schief gelaufen!',
  seeIssue: 'SIEHE PROBLEM',
  ...
  helperText:
    'Die erstellte Ausgabe enthält Kontextinformationen wie die URL und die Position des ausgewählten Textes im Dokument.',
