                ...
                <Grid item xs={12}>
                  ...
                  >
                    ...
                    <Box sx={{ width: '100%' }}>
                      ...
                      <Tooltip title={getSectionNameForUri(item.sectionName, sectionNames) || 'No Section'}>
                        <Typography 
                          variant="body2" 
                          fontWeight="medium"
                          sx={{
                ...
                <Grid item xs={12}>
                  ...
                  >
                    ...
                    <Box sx={{ width: '100%' }}>
                      ...
                      <Tooltip title={getSectionNameForUri(item.targetSectionName, sectionNames) || 'No Target'}>
                        <Typography 
                          variant="body2" 
                          fontWeight="medium"
                          sx={{
