import { Button, Dialog, DialogActions, DialogContent, DialogTitle, MenuItem, Step, StepLabel, Stepper, TextField } from "@mui/material";
import { getOrganizationId, OrganizationData, RecruiterAndOrgData, RecruiterData, updateOrganizationProfile, upDateRecruiterProfile } from "@stex-react/api";
...
const RecruiterProfileStepper = ({ activeStep, steps }: { activeStep: number; steps: string[] }) => (
  ...
  const RecruiterDetailsForm = ({
    ...
    onChange:  (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>, section: FormSection) => void
}) => (
          ...
          <DialogContent>
            ...
            {activeStep === 1 && (
              <OrganizationInfoForm
                formData={formData.organizationInfo}
                onChange={handleChange}
              />
            )}
          </DialogContent>
