export const SYSTEM_UPDATES = [
  /*{
    ...
    content: `Help us to evaluate ALᴇA by participating in this fifteen minute survey.
        ...
        \n [![qrcode](../ALeA_Eval25.png)](https://ddi-survey.cs.fau.de/limesurvey/index.php/667123?lang=en)`,
  ...
  },
  {
    ...
    content: `We're excited to announce that we've added a new feature to our system: email-password login! Now, in addition to our existing authentication methods, you can securely log in using your email address and password.
      Your feedback is valuable to us as we continue to improve our services. If you encounter any issues or have suggestions for further enhancements, please don't hesitate to reach out.`,
    ...
    content_de: `Wir freuen uns, bekannt zu geben, dass wir unserem System ein neues Feature hinzugefügt haben: die Anmeldung per E-Mail und Passwort! Ab sofort können Sie sich neben unseren bestehenden Authentifizierungsmethoden sicher mit Ihrer E-Mail-Adresse und Ihrem Passwort anmelden.
      Ihr Feedback ist für uns wertvoll, während wir unsere Dienste kontinuierlich verbessern. Wenn Sie auf Probleme stoßen oder Vorschläge für weitere Verbesserungen haben, zögern Sie bitte nicht, uns zu kontaktieren.`,
