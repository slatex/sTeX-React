...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h35bb0f0f765c1d64: (a: number, b: number) => void;
export const closure158_externref_shim: (a: number, b: number, c: any) => void;
export const closure848_externref_shim: (a: number, b: number, c: any) => number;
